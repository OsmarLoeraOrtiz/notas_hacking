...
┌──(kali㉿kali)-[~/Downloads]
└─$ ls
 1                      docProps               flag                     mystery                    Qatar
 buildings.png          dolls.jpg              flag.png                 Obsidian-0.15.9.AppImage   _rels
'capture(1).pcap'       _dolls.jpg.extracted  'Forensics is fun.pptm'   pico_img.png               result.png
'capture(2).pcap'       exp2.py                garden.jpg              'picopico(1).key'           tunn3l_v1s10n
 capture.pcap           exp.py                 legends                  picopico.key               whitepages.txt
'[Content_Types].xml'   filler.txt             message.wav              ppt
...
Se busca con ayuda del explorador de archivos la bandera dentro de todas las carpetas. La bandera estaba en una archivo txt llamado "hidden" y esta en base64
                                                                                                                  
┌──(kali㉿kali)-[~/Downloads]
└─$ cat "Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q" | tr -d " "
cat: 'Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q': No such file or directory
